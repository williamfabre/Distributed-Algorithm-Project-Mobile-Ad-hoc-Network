...
\begingroup\let\clearpage\relax
	...
	\mylisting[basicstyle=\tiny,frame=rlbt,language=Bash]{../README}
	...
	\mylisting[basicstyle=\tiny,frame=rlbt,language=Java, firstline=217, lastline=249]{../src/ara/manet/Echantillon.java}
	...
	\begin{figure}[H]
		\mylisting[basicstyle=\tiny,frame=rlbt,language=Java, firstline=1, lastline=31]{../src/ara/config} %with frame
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth, frame]{instabi}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth, frame]{messages}
